 ...
 *  Write a java program to input student Name, roll No, and three subjects Math, Science and English marks (marks is between 0 to 100 and if it is out of range print error message “Invalid
...
public class Programme2_Marksheet {
    ...
    public static void main(String[] args) {
        do {
            Programme2_Marksheet obj1 = new Programme2_Marksheet();
            ...
            System.out.println("would  you like to do more, Please enter 'Y' or 'N' ");
            user = t.next().toLowerCase().charAt(0);
            printAgainTheMarkSheet(name,rollNum,mathsMarks);
    ...
    //printAgainTheMarkSheet method
    public static void printAgainTheMarkSheet(String name, int rollNum, int mathsMarks) {
        System.out.println("-----------------------------");
        System.out.println("|                           |");
        System.out.println("| Mark Sheet                |");
        System.out.println("|___________________________|");
